...
describe('server', function(){
    ...
    before(function(done){
        original = Carapace.Image.create(path.resolve(__dirname, './runner/magritte.png'))
        cropped = Carapace.Image.create(path.resolve(__dirname, './runner/magritte-cropped.png'))
        async.parallel([
